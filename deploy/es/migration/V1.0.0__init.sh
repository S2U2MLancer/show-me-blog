...
curl -XPUT "http://localhost:9200/article" -H 'Content-Type: application/json' \
...
curl -XPOST "http://localhost:9200/_scripts/article_label_statistic" -H 'Content-Type: application/json' \
...
curl -XPOST "http://localhost:9200/_scripts/label_articles" -H 'Content-Type: application/json' \
